<?php 
    ...
    $all_customers_data = shopify_call($access_token, $shop, "/admin/api/2020-01/customers/search.json?query=wholesale-approved", array(), 'GET');
    ...
    <table class="table table-hover table-bordered">
        ...
        <tbody>
            ...
            <tr class="empty-msg d-none">
                <td colspan="13">There are no approved accounts!</td>
            </tr>
        </tbody>
    </table>
</div>
