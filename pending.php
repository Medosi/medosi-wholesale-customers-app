<?php 
    ...
    $all_customers_data = shopify_call($access_token, $shop, "/admin/api/2020-01/customers/search.json?query=wholesale-pending", array(), 'GET');
    ...
    <table class="table table-hover table-bordered">
        ...
        <tbody>
            ...
            <tr class="empty-msg d-none">
                <td colspan="12">There are no pending accounts!</td>
            </tr>
        </tbody>
    </table>
</div>
